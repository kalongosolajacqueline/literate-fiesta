...
console.log("Sofia's age:", friends.find(friend => friend.name === "Sofia").age);
...
// Remove "Tuesday" using .splice and assign it to a variable
const removedDay = weekDays.splice(1, 1)[0];

// Add "Tuesday" back to the array using .splice
weekDays.splice(2, 0, removedDay);
...
// Adding the rest of the weekdays using .push method
...
removedDay = weekDays.shift();
weekDays.push(removedDay);

console.log("Question #6 ", weekDays[0] === "Sunday" ? "is correct." : "is incorrect.");
...
// Make a copy of the weekDays array
const reversedWeekDays = weekDays.slice();

// Reverse the copied array
reversedWeekDays.reverse();

// Alternatively, you can use the spread operator to create a copy and reverse it in a single step:
...
const reversedWrittenNumbers = writtenNumbers.slice().reverse();

console.log("Reversed writtenNumbers:", reversedWrittenNumbers);
...
const numTimesSeven = num.map(item => item * 7);
